...
public class BleTriggerActivity extends ActionBarActivity implements AuthListener, SyncListener,
 ...
 //       Triggers.getTriggersManager(this).startMonitoring();
    ...
    public Boolean przeniczne = false;
    public Boolean zbozowe = false;
    ...
    public void onCheckboxClicked(View view) {
        ...
        switch(view.getId()) {
            case R.id.checkbox_pszeniczne:
                przeniczne = checked;
                break;
            case R.id.checkbox_zozowe:
               zbozowe = checked;
                break;
        }
    }
    ...
    public void onStart(View view) {
        ((CheckBox) findViewById(R.id.checkbox_pszeniczne)).setVisibility(View.INVISIBLE);
        ((CheckBox) findViewById(R.id.checkbox_zozowe)).setVisibility(View.INVISIBLE);
        ((RecyclerView) findViewById(R.id.rvBeaconEventList)).setVisibility(View.VISIBLE);
    ...
    private void configureBeaconEventList() {
        ...
        mImageMap.put("Stara Zajezdnia", R.drawable.a10);
        mImageMap.put("Tap House", R.drawable.a12);
